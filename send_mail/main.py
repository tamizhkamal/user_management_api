...
conf = ConnectionConfig(
    ...
    MAIL_PASSWORD="eqjm gvrp eyut rzsy",  # Your App Password
...
#     html = """<p>Hi, this is a test email from FastAPI.</p>"""

#     message = MessageSchema(
#         subject="FastAPI-Mail Test Email",
...
# async def send_email(email: EmailSchema) -> JSONResponse:
#     html = """
#     [Your full HTML template here]
#     """

#     message = MessageSchema(
#         subject="FastAPI-Mail Test Email",
#         recipients=email.email,  # You can send to multiple addresses
#         body=html,
#         subtype=MessageType.html,
#     )
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="center" style="font-family: 'Lato', sans-serif; font-size:15px; color:#ffffff; line-height:24px; font-weight: 300;">
                        It's zoonest software solution sample mail promotions <br>and products across different email platforms.
                      </td>
                    </tr>
